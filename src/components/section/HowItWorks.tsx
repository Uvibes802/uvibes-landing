  ...
  return (
    <section className={`how-section${vis ? " how-vis" : ""}`} ref={ref}>
      ...
      <div className="how-header">
        ...
        {/* Bouton avant les 3 étapes → page Méthode (/solution) */}
        <div className="how-cta-pre-wrap">
          <Link href="/solution" className="how-cta-pre">
      ...
      <div className="how-cta-wrap">
        <Link href="/tarifs" className="btn-brand how-cta">
          Découvrir nos offres Uvibes
