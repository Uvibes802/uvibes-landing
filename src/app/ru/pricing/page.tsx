...
export const metadata: Metadata = buildMetadata("tarifs", "ru");
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Цены", item: `${SITE_URL}/ru/pricing` },
  ],
};
