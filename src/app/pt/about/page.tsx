...
export const metadata: Metadata = buildMetadata("uvibes", "pt");
...
const organizationJsonLd = {
  ...
  description: "A Uvibes é uma inovação sociodigital que promove conversas positivas dentro dos coletivos para fortalecer o vínculo social, o bem-estar e o compromisso humano.",
  foundingDate: "2022",
  sameAs: ["https://www.linkedin.com/company/uvibes", "https://www.instagram.com/uvibes_app"],
};

const ETHICS = [
  { num: "01", title: "Serviço responsável", text: "Um serviço digital respeitoso, pensado para a qualidade das conversas, a inclusão e a privacidade dos dados." },
  { num: "02", title: "Projeto comprometido", text: "Decisões de projeto alinhadas com os nossos valores — baseadas na escuta, na colaboração e na responsabilidade ambiental." },
  { num: "03", title: "Parcerias duradouras", text: "Parcerias responsáveis, escolhidas pela sua transparência, o seu impacto positivo e o seu compromisso com a sociedade." },
];

const VALUES = [
  "A magia das histórias partilhadas",
  "A alegria de partilhar experiências pessoais",
  "E a riqueza de novas perspetivas.",
];
    ...
    <main className="uv-page">
      ...
      <section className="uv-hero">
        ...
        <div className="uv-hero-inner">
          <h1 className="uv-hero-title v-prompt">
            Quem dá<br />
            <em className="uv-hero-em">vida à Uvibes?</em>
          </h1>
          <p className="uv-hero-sub">
            Conheça as pessoas e as ideias por detrás do crescimento da Uvibes
          </p>
        </div>
      ...
      <section className="uv-intro">
        ...
        <div className="uv-intro-statement-card">
          ...
          O estudo mais longo realizado por Harvard descobriu que a qualidade das nossas relações
          é o <em className="uv-em-orange">preditor mais forte da felicidade</em>{" "}
        ...
        <div className="uv-intro-inner">
          <div>
            <p className="uv-eyebrow"><span className="uv-eyebrow-dot" aria-hidden="true" />Onde nasceu a ideia</p>
            <h2 className="uv-intro-title">
              E se<br />
              <em className="uv-serif-accent">realmente conversássemos?</em>
            </h2>
            <p className="uv-intro-body">
              Nas redes sociais tradicionais, os algoritmos ligam-nos a pessoas que pensam como nós. Na vida real, ficamos em círculos conhecidos, comentamos mais do que realmente conversamos e, pouco a pouco… perdemos a riqueza da diversidade humana.
            </p>
            {/* Chez Uvibes, nous croyons à — phrase filée, sans liste ni numéros */}
            <p className="uv-thread">
              <span className="uv-thread-eyebrow">Na Uvibes, acreditamos em&nbsp;:&nbsp;</span>
              {VALUES.map((v, i) => (
                <span key={v}>
            ...
            <p className="uv-intro-body">
              Numa universidade, numa empresa ou em qualquer outro coletivo, muitas pessoas gostariam de se ligar assim, mas não se atrevem.
              <br /><br />
              A Uvibes torna possíveis esses encontros inesperados, através de um jogo de perguntas abertas e positivas. Porque é dando um passo para o <em className="uv-em-rose">desconhecido</em> que nascem as conversas mais <em className="uv-em-orange">bonitas</em>.
            </p>
          </div>
      ...
      <div className="uv-team-gradient-wrap" style={{ background: "linear-gradient(145deg, #FF5894 0%, #FF7A60 30%, #FFB040 60%, #FD6E00 85%, #D90A5C 100%)", position: "relative", overflow: "hidden" }}>
        ...
        <section className="uv-team uv-team--on-gradient">
          ...
          <div className="uv-waves" aria-hidden="true">
            <GradientVibrationLine id="uv-tw1-pt" width={1800} height={70} amplitude={30} freq={5} strokeWidth={22} speed={10} colorFrom="#fff" colorTo="#FFE456" style={{ width: "100%" }} />
            <GradientVibrationLine id="uv-tw2-pt" width={1800} height={70} amplitude={24} freq={7} strokeWidth={15} speed={14} colorFrom="#fff" colorTo="#FFE456" style={{ width: "100%" }} />
            <GradientVibrationLine id="uv-tw3-pt" width={1800} height={70} amplitude={34} freq={4} strokeWidth={18} speed={12} colorFrom="#FFE456" colorTo="#fff" style={{ width: "100%" }} />
          </div>
          <div className="uv-team-inner">
            <div className="uv-section-header">
              <p className="uv-eyebrow uv-team-eyebrow"><span className="uv-eyebrow-dot" aria-hidden="true" />Ganha vida</p>
              <h2 className="uv-section-title uv-team-title">A equipa por detrás da <em className="uv-serif-accent uv-serif-accent--yellow">Uvibes</em></h2>
            </div>
            <TeamSection locale="pt" />
          </div>
        </section>
        ...
        <div className="uv-ethics-inner">
          <div className="uv-ethics-header">
            <div className="uv-ethics-header__text">
              <p className="uv-eyebrow"><span className="uv-eyebrow-dot" aria-hidden="true" />O nosso compromisso</p>
              <h2 className="uv-section-title">Uma abordagem <em className="uv-serif-grad">ética</em> no centro</h2>
            </div>
          ...
          <p className="uv-ethics-blog-note">
            Explore a secção <Link href="/blog" className="uv-ethics-blog-link">&ldquo;Uvibes&rdquo;</Link> do nosso blog
            para saber mais sobre os nossos princípios éticos e como os pomos em prática.
          </p>
      ...
      <section className="uv-don" style={{ background: "transparent" }}>
        <div className="uv-don-inner">
          <p className="uv-eyebrow uv-don-eyebrow"><span className="uv-eyebrow-dot" aria-hidden="true" />Quem dirige o projeto</p>
          <h2 className="uv-join-title uv-don-title">
            Apoie um{" "}
            <em className="uv-serif-accent uv-serif-accent--yellow v-serif">modelo sem fins lucrativos</em>
          </h2>
          <p className="uv-join-sub uv-don-sub">
            A Uvibes é gerida pela associação Eclat&apos;Ens. Todas as receitas geradas são
            reinvestidas no projeto ou em outras iniciativas promovidas pela associação.
          </p>

          <div className="uv-don-badge">
            <span className="uv-don-badge-label">Um projeto promovido por</span>
            <Image src="/images/LogoEclatens.png" alt="Logótipo da associação Éclatens" width={300} height={132} className="uv-don-logo" />
          </div>

          <div className="uv-don-actions">
            <HelloAssoDon locale="pt" />
