...
export const metadata: Metadata = buildMetadata("tarifs", "pt");
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Preços", item: `${SITE_URL}/pt/pricing` },
  ],
};
