...
export const metadata: Metadata = buildMetadata("home", "pt");
...
export default async function HomePt() {
  ...
  return (
    <main>
      ...
      <ConversationIntro locale="pt" />

      <BannerCount locale="pt" />

      <ValuePillars locale="pt" />

      <CollectifsSection showCta={true} locale="pt" />

      <HowItWorks locale="pt" />

      <PasseportExperience locale="pt" />

      <PartnerCarousel logos={partners} locale="pt" />
