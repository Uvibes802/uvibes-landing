...
export const metadata: Metadata = buildMetadata("uvibes", "ja");
...
const organizationJsonLd = {
  ...
  description: "Uvibesは、コミュニティ内でのポジティブな対話を促進し、社会的つながり、ウェルビーイング、人間的な関わりを強化する社会デジタルイノベーションです。",
  foundingDate: "2022",
  sameAs: ["https://www.linkedin.com/company/uvibes", "https://www.instagram.com/uvibes_app"],
};

const ETHICS = [
  { num: "01", title: "責任あるサービス", text: "対話の質、インクルージョン、データの保護を重視した、敬意あるデジタルサービス。" },
  { num: "02", title: "誠実なプロジェクト", text: "傾聴、協力、環境責任に基づき、私たちの価値観に沿ったプロジェクトの意思決定。" },
  { num: "03", title: "持続的なパートナーシップ", text: "透明性、ポジティブな影響、社会への貢献を理由に選ばれた、責任あるパートナーシップ。" },
];
    ...
    <main className="uv-page">
      ...
      <section className="uv-hero">
        ...
        <div className="uv-hero-inner">
          <h1 className="uv-hero-title v-prompt">
            誰が<br />
            <em className="uv-hero-em">Uvibesに命を与えるのか？</em>
          </h1>
          <p className="uv-hero-sub">
            Uvibesの成長を支える人々とアイデアを知る
          </p>
        </div>
      ...
      <section className="uv-intro">
        ...
        <div className="uv-intro-statement-card">
          ...
          ハーバード大学が行った最長の研究によると、私たちの関係の質は
          <em className="uv-em-orange">幸福の最も強い予測因子</em>{" "}
          であることが分かりました<span className="uv-intro-statement-cite">（Vaillant、2002年）</span>。
          </p>
        </div>

        <div className="uv-intro-inner">
          <div>
            <p className="uv-eyebrow"><span className="uv-eyebrow-dot" aria-hidden="true" />アイデアが生まれた場所</p>
            <h2 className="uv-intro-title">
              もし<br />
              <em className="uv-serif-accent">本当に語り合えたら？</em>
            </h2>
            <p className="uv-intro-body">
              従来のソーシャルネットワークでは、アルゴリズムが私たちと同じ考えを持つ人々を結びつけます。実生活では、私たちは見知った輪の中に留まり、本当に話すよりも多くコメントし、徐々に……人間の多様性という豊かさを失っていきます。
            </p>
            {/* Chez Uvibes, nous croyons à — phrase filée, sans liste ni numéros */}
            <p className="uv-thread">
              <span className="uv-thread-eyebrow">Uvibesは、次のことを信じています&nbsp;：&nbsp;</span>
              {VALUES.map((v, i) => (
                <span key={v}>
            ...
            <p className="uv-intro-body">
              大学、企業、あるいは他のどんなコレクティフでも、多くの人がこのようにつながりたいと思いながらも、あえてその一歩を踏み出せません。
              <br /><br />
              Uvibesは、オープンでポジティブな質問のゲームを通じて、こうした予想外の出会いを可能にします。なぜなら、<em className="uv-em-rose">未知</em>へ一歩踏み出すことから、最も<em className="uv-em-orange">美しい</em>対話が生まれるからです。
            </p>
          </div>
      ...
      <div className="uv-team-gradient-wrap" style={{ background: "linear-gradient(145deg, #FF5894 0%, #FF7A60 30%, #FFB040 60%, #FD6E00 85%, #D90A5C 100%)", position: "relative", overflow: "hidden" }}>
        ...
        <section className="uv-team uv-team--on-gradient">
          ...
          <div className="uv-waves" aria-hidden="true">
            <GradientVibrationLine id="uv-tw1-ja" width={1800} height={70} amplitude={30} freq={5} strokeWidth={22} speed={10} colorFrom="#fff" colorTo="#FFE456" style={{ width: "100%" }} />
            <GradientVibrationLine id="uv-tw2-ja" width={1800} height={70} amplitude={24} freq={7} strokeWidth={15} speed={14} colorFrom="#fff" colorTo="#FFE456" style={{ width: "100%" }} />
            <GradientVibrationLine id="uv-tw3-ja" width={1800} height={70} amplitude={34} freq={4} strokeWidth={18} speed={12} colorFrom="#FFE456" colorTo="#fff" style={{ width: "100%" }} />
          </div>
          <div className="uv-team-inner">
            <div className="uv-section-header">
              <p className="uv-eyebrow uv-team-eyebrow"><span className="uv-eyebrow-dot" aria-hidden="true" />命が宿る</p>
              <h2 className="uv-section-title uv-team-title"><em className="uv-serif-accent uv-serif-accent--yellow">Uvibes</em>を支えるチーム</h2>
            </div>
        ...
        <div className="uv-ethics-inner">
          <div className="uv-ethics-header">
            <div className="uv-ethics-header__text">
              <p className="uv-eyebrow"><span className="uv-eyebrow-dot" aria-hidden="true" />私たちの誓い</p>
              <h2 className="uv-section-title"><em className="uv-serif-grad">倫理的な</em>アプローチを中心に</h2>
            </div>
          ...
          <p className="uv-ethics-blog-note">
            ブログの <Link href="/blog" className="uv-ethics-blog-link">&ldquo;Uvibes&rdquo;</Link> セクションをご覧いただき、
            私たちの倫理原則とその実践方法について詳しくお知りください。
          </p>
      ...
      <section className="uv-don" style={{ background: "transparent" }}>
        <div className="uv-don-inner">
          <p className="uv-eyebrow uv-don-eyebrow"><span className="uv-eyebrow-dot" aria-hidden="true" />プロジェクトを率いるのは誰か</p>
          <h2 className="uv-join-title uv-don-title">
            <em className="uv-serif-accent uv-serif-accent--yellow v-serif">非営利モデル</em>を支援する
          </h2>
          <p className="uv-join-sub uv-don-sub">
            Uvibesは協会Eclat&apos;Ensによって運営されています。得られた収益はすべて、
            本プロジェクトまたは協会が推進する他の取り組みに再投資されます。
          </p>

          <div className="uv-don-badge">
            <span className="uv-don-badge-label">推進プロジェクト：</span>
            <Image src="/images/LogoEclatens.png" alt="Éclatens協会のロゴ" width={300} height={132} className="uv-don-logo" />
          </div>

          <div className="uv-don-actions">
            <HelloAssoDon locale="ja" />
