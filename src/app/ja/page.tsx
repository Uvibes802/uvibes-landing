...
export const metadata: Metadata = buildMetadata("home", "ja");
...
export default async function HomeJa() {
  ...
  return (
    <main>
      ...
      <ConversationIntro locale="ja" />

      <BannerCount locale="ja" />

      <ValuePillars locale="ja" />

      <CollectifsSection showCta={true} locale="ja" />

      <HowItWorks locale="ja" />

      <PasseportExperience locale="ja" />

      <PartnerCarousel logos={partners} locale="ja" />
