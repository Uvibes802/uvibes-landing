...
export const metadata: Metadata = buildMetadata("tarifs", "ja");
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "料金", item: `${SITE_URL}/ja/pricing` },
  ],
};
