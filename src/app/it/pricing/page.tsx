...
export const metadata: Metadata = buildMetadata("tarifs", "it");
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Prezzi", item: `${SITE_URL}/it/pricing` },
  ],
};
