...
export const metadata: Metadata = buildMetadata("tarifs", "zh");
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "价格", item: `${SITE_URL}/zh/pricing` },
  ],
};
