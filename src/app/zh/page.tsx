...
export const metadata: Metadata = buildMetadata("home", "zh");
...
export default async function HomeZh() {
  ...
  return (
    <main>
      ...
      <ConversationIntro locale="zh" />

      <BannerCount locale="zh" />

      <ValuePillars locale="zh" />

      <CollectifsSection showCta={true} locale="zh" />

      <HowItWorks locale="zh" />

      <PasseportExperience locale="zh" />

      <PartnerCarousel logos={partners} locale="zh" />
