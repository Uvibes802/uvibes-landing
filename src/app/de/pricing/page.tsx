...
export const metadata: Metadata = buildMetadata("tarifs", "de");
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Preise", item: `${SITE_URL}/de/pricing` },
  ],
};
