...
export default async function HomeDe() {
  ...
  return (
    <main>
      ...
      <ConversationIntro locale="de" />

      <BannerCount locale="de" />

      <ValuePillars locale="de" />

      <CollectifsSection showCta={true} locale="de" />

      <HowItWorks locale="de" />

      <PasseportExperience locale="de" />

      <PartnerCarousel logos={partners} locale="de" />
