...
export const metadata: Metadata = buildMetadata("uvibes", "ar");
...
const organizationJsonLd = {
  ...
  description: "Uvibes هو ابتكار اجتماعي-رقمي يعزز الحوارات الإيجابية داخل المجموعات لتقوية الرابط الاجتماعي والرفاه والالتزام الإنساني.",
  foundingDate: "2022",
  sameAs: ["https://www.linkedin.com/company/uvibes", "https://www.instagram.com/uvibes_app"],
};

const ETHICS = [
  { num: "01", title: "خدمة مسؤولة", text: "خدمة رقمية تحترم المستخدم، مصممة من أجل جودة الحوارات، والشمولية، وخصوصية البيانات." },
  { num: "02", title: "مشروع ملتزم", text: "قرارات المشروع متوافقة مع قيمنا — قائمة على الاستماع والتعاون والمسؤولية البيئية." },
  { num: "03", title: "شراكات دائمة", text: "شراكات مسؤولة، تم اختيارها لشفافيتها وأثرها الإيجابي وتعهدها تجاه المجتمع." },
];

const VALUES = [
  "سحر القصص المشتركة",
  "فرحة تبادل التجارب الشخصية",
  "وثراء وجهات النظر الجديدة.",
];
    ...
    <main className="uv-page">
      ...
      <section className="uv-hero">
        ...
        <div className="uv-hero-inner">
          <h1 className="uv-hero-title v-prompt">
            من يبعث<br />
            <em className="uv-hero-em">الحياة في Uvibes؟</em>
          </h1>
          <p className="uv-hero-sub">
            تعرف على الأشخاص والأفكار التي تقود نمو Uvibes
          </p>
        </div>
      ...
      <section className="uv-intro">
        ...
        <div className="uv-intro-statement-card">
          ...
          وجدت أطول دراسة أجرتها جامعة هارفارد أن جودة علاقاتنا هي
          <em className="uv-em-orange">أقوى مؤشر على السعادة</em>{" "}
        ...
        <div className="uv-intro-inner">
          <div>
            <p className="uv-eyebrow"><span className="uv-eyebrow-dot" aria-hidden="true" />أين وُلدت الفكرة</p>
            <h2 className="uv-intro-title">
              ماذا لو<br />
              <em className="uv-serif-accent">تحدثنا حقًا؟</em>
            </h2>
            <p className="uv-intro-body">
              في الشبكات الاجتماعية التقليدية، تربطنا الخوارزميات بأشخاص يفكرون مثلنا. وفي الحياة الحقيقية، نبقى في دوائر معروفة، ونعلّق أكثر مما نتحدث فعليًا، وبالتدريج… نفقد ثراء التنوع الإنساني.
            </p>
            {/* Chez Uvibes, nous croyons à — phrase filée, sans liste ni numéros */}
            <p className="uv-thread">
              <span className="uv-thread-eyebrow">في Uvibes، نؤمن بـ&nbsp;:&nbsp;</span>
              {VALUES.map((v, i) => (
                <span key={v}>
            ...
            <p className="uv-intro-body">
              في جامعة أو شركة أو أي مجموعة أخرى، يرغب كثيرون في التواصل على هذا النحو، لكنهم لا يجرؤون.
              <br /><br />
              تجعل Uvibes هذه اللقاءات غير المتوقعة ممكنة، من خلال لعبة من الأسئلة المفتوحة والإيجابية. لأنه بخطوة نحو <em className="uv-em-rose">المجهول</em> تولد أجمل <em className="uv-em-orange">المحادثات</em>.
            </p>
          </div>
      ...
      <div className="uv-team-gradient-wrap" style={{ background: "linear-gradient(145deg, #FF5894 0%, #FF7A60 30%, #FFB040 60%, #FD6E00 85%, #D90A5C 100%)", position: "relative", overflow: "hidden" }}>
        ...
        <section className="uv-team uv-team--on-gradient">
          ...
          <div className="uv-waves" aria-hidden="true">
            <GradientVibrationLine id="uv-tw1-ar" width={1800} height={70} amplitude={30} freq={5} strokeWidth={22} speed={10} colorFrom="#fff" colorTo="#FFE456" style={{ width: "100%" }} />
            <GradientVibrationLine id="uv-tw2-ar" width={1800} height={70} amplitude={24} freq={7} strokeWidth={15} speed={14} colorFrom="#fff" colorTo="#FFE456" style={{ width: "100%" }} />
            <GradientVibrationLine id="uv-tw3-ar" width={1800} height={70} amplitude={34} freq={4} strokeWidth={18} speed={12} colorFrom="#FFE456" colorTo="#fff" style={{ width: "100%" }} />
          </div>
          <div className="uv-team-inner">
            <div className="uv-section-header">
              <p className="uv-eyebrow uv-team-eyebrow"><span className="uv-eyebrow-dot" aria-hidden="true" />تنبض بالحياة</p>
              <h2 className="uv-section-title uv-team-title">الفريق وراء <em className="uv-serif-accent uv-serif-accent--yellow">Uvibes</em></h2>
            </div>
            <TeamSection locale="ar" />
          </div>
        </section>
        ...
        <div className="uv-ethics-inner">
          <div className="uv-ethics-header">
            <div className="uv-ethics-header__text">
              <p className="uv-eyebrow"><span className="uv-eyebrow-dot" aria-hidden="true" />التزامنا</p>
              <h2 className="uv-section-title">نهج <em className="uv-serif-grad">أخلاقي</em> في القلب</h2>
            </div>
          ...
          <p className="uv-ethics-blog-note">
            استكشف قسم <Link href="/blog" className="uv-ethics-blog-link">&ldquo;Uvibes&rdquo;</Link> في مدونتنا
            لمعرفة المزيد عن مبادئنا الأخلاقية وكيف نطبقها عمليًا.
          </p>
      ...
      <section className="uv-don" style={{ background: "transparent" }}>
        <div className="uv-don-inner">
          <p className="uv-eyebrow uv-don-eyebrow"><span className="uv-eyebrow-dot" aria-hidden="true" />من يقود المشروع</p>
          <h2 className="uv-join-title uv-don-title">
            ادعم{" "}
            <em className="uv-serif-accent uv-serif-accent--yellow v-serif">نموذجًا غير ربحي</em>
          </h2>
          <p className="uv-join-sub uv-don-sub">
            تُدار Uvibes من قبل جمعية Eclat&apos;Ens. يُعاد استثمار جميع العائدات المحققة
            في المشروع أو في مبادرات أخرى تقودها الجمعية.
          </p>

          <div className="uv-don-badge">
            <span className="uv-don-badge-label">مشروع تقوده</span>
            <Image src="/images/LogoEclatens.png" alt="شعار جمعية Éclatens" width={300} height={132} className="uv-don-logo" />
          </div>

          <div className="uv-don-actions">
            <HelloAssoDon locale="ar" />
