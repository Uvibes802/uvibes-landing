...
export default async function HomeAr() {
  ...
  return (
    <main>
      ...
      <ConversationIntro locale="ar" />

      <BannerCount locale="ar" />

      <ValuePillars locale="ar" />

      <CollectifsSection showCta={true} locale="ar" />

      <HowItWorks locale="ar" />

      <PasseportExperience locale="ar" />

      <PartnerCarousel logos={partners} locale="ar" />
