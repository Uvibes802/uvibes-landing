...
export const metadata: Metadata = buildMetadata("home", "hi");
...
export default async function HomeHi() {
  ...
  return (
    <main>
      ...
      <ConversationIntro locale="hi" />

      <BannerCount locale="hi" />

      <ValuePillars locale="hi" />

      <CollectifsSection showCta={true} locale="hi" />

      <HowItWorks locale="hi" />

      <PasseportExperience locale="hi" />

      <PartnerCarousel logos={partners} locale="hi" />
