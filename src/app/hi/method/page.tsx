...
export const metadata: Metadata = buildMetadata("solution", "hi");

const breadcrumbJsonLd = {
  "@context": "https://schema.org",
  "@type": "BreadcrumbList",
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "होम", item: `${SITE_URL}/hi` },
    { "@type": "ListItem", position: 2, name: "तरीका", item: `${SITE_URL}/hi/method` },
  ],
};
...
export default function MethodPageHi() {
  return (
    <>
      ...
      <SolutionAnchorNav locale="hi" />

      <main className="sol-main-content">
        <SolutionHowItWorks locale="hi" />
        <SolutionThemes locale="hi" />
        ...
        <div className="str-gradient-wrap" style={{ background: HERO_GRADIENT, position: "relative", overflow: "hidden" }}>
          ...
          <SolutionStrategie locale="hi" />
          <WaveSeparator position="bottom" color="#FFF0F8" />
        </div>

        <SolutionSoftSkills locale="hi" />
        {/* Renvoi vers les tarifs, juste avant la section Résultats */}
        <div className="sol-offers-cta">
          <Link href="/hi/pricing" className="btn-brand sol-offers-cta-btn">
            हमारी Uvibes योजनाएं देखें →
          </Link>
        </div>
        <FeaturesCard locale="hi" />
        ...
        <div style={{ background: "linear-gradient(160deg, #FD6E00 0%, #FF6030 18%, #FF6098 45%, #E6007E 70%, #D90A5C 100%)", position: "relative", overflow: "hidden" }}>
          ...
          <section className="sol-tarifs-bridge">
            <p className="sol-bridge-eyebrow">शुरू करने के लिए तैयार हैं?</p>
            <h2 className="sol-bridge-title v-prompt">हमारी Uvibes योजनाओं को जानें</h2>
            <p className="sol-bridge-sub">
              हर समूह के लिए उपयुक्त योजनाएं, साथ ही बिना किसी प्रतिबद्धता के आज़माने के लिए 30 दिनों की ट्रायल पेशकश।
            </p>
            <Link href="/hi/pricing" className="btn-brand sol-bridge-cta">
              योजनाएं और कीमतें देखें →
            </Link>
          </section>
          <Footer locale="hi" />
        </div>
