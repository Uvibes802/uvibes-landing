...
export const metadata: Metadata = buildMetadata("tarifs", "hi");
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "कीमतें", item: `${SITE_URL}/hi/pricing` },
  ],
};
