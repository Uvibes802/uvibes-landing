...
export const metadata: Metadata = buildMetadata("solution", "en");
...
export default function MethodPageEn() {
  return (
    <>
      ...
      <SolutionAnchorNav locale="en" />

      <main className="sol-main-content">
        <SolutionHowItWorks locale="en" />
        <SolutionThemes locale="en" />
        <SolutionStrategie locale="en" />
        <SolutionSoftSkills locale="en" />
        {/* Renvoi vers les tarifs, juste avant la section Résultats */}
        <div className="sol-offers-cta">
          <Link href="/en/pricing" className="btn-brand sol-offers-cta-btn">
            Our Uvibes plans →
          </Link>
        </div>
        <FeaturesCard locale="en" />
        ...
        <div style={{ background: "linear-gradient(160deg, #FD6E00 0%, #FF6030 18%, #FF6098 45%, #E6007E 70%, #D90A5C 100%)", position: "relative", overflow: "hidden" }}>
          ...
          <section className="sol-tarifs-bridge">
            <p className="sol-bridge-eyebrow">Ready to get started?</p>
            <h2 className="sol-bridge-title v-prompt">Discover our Uvibes plans</h2>
            <p className="sol-bridge-sub">
              Plans tailored to every community, plus a 30-day trial to test it out, no commitment.
            </p>
            <Link href="/en/pricing" className="btn-brand sol-bridge-cta">
